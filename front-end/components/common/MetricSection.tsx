...
const MetricSection = ({
  ...
  return (
    <div
      className={`w-full px-4 py-14 gap-12 lg:gap-20 inline-flex flex-col items-center text-center overflow-clip font-['Inter']`}
    >
      <p className="text-4xl font-bold m-0   text-neutral-900 md:text-5xl">
        {heading}
      </p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full bg-green-400 ">
