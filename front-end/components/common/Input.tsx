...
const Input = ({
  ...
  return (
    <div className={`form-control w-full relative ${className}`}>
      ...
      <input
        {...inputprops}
        className={`input input-bordered border-2 border-neutral-300 focus:shadow-lg focus:outline-none focus:border-secondary input-secondary ${focusColor} w-full p-3 ${
          leftIcon ? "pl-12" : ""
        }`}
      />
